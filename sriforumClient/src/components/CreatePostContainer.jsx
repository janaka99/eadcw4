...
const CreatePostContainer = ({ setCreatePostView, loadPosts }) => {
  ...
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    if (quection == "" || quection == undefined) {
      console.log("Quection can not be empty");
      setLoading(false);
    } else {
      API.post("post/add-new-post", { post: quection })
        .then((response) => {
      ...
      <Content ref={containerRef}>
        <Form action="" ref={formRef} onSubmit={(e) => handleFormSubmit(e)}>
          ...
          <CreatePost>
            ...
            <TextArea>
              <textarea
                onChange={(e) => setQuection(e.target.value)}
                name=""
